...
g1 = skimage.io.imread('Green_t0.tif')
b1 = skimage.io.imread('Blue_t0.tif')
r1 = skimage.io.imread('Red_t0.tif')
g2 = skimage.io.imread('Green_t24.tif')
b2 = skimage.io.imread('Blue_t24.tif')
r2 = skimage.io.imread('Red_t24.tif')
g3 = skimage.io.imread('Green_t48.tif')
b3 = skimage.io.imread('Blue_t48.tif')
r3 = skimage.io.imread('Red_t48.tif')
