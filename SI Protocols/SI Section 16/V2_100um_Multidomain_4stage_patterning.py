...
filename = '4_stage_patterning_shapes_100umChannel_150umGels_'
posi = ("skip", 'Cy3gels_', 'Tye665gels_','ATTO488gels_','AllColorgels_')
...
for stage in range(1,5):
    ...
    for i in range(0,4):
        ...
        time.sleep(1)
        if i == 0:
            core.setRelativeXYPosition(0, (stage-1)*150.0)                   
            if stage == 1:
                output = draw_square # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 2:
                output = draw_circle # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 3:
                output = draw_triangle # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 4:
                output = draw_plus # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
        ...
        if i == 1:
            if stage == 1:
                core.setRelativeXYPosition(0, (stage)*150.0)
                output = draw_circle # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 2:
                core.setRelativeXYPosition(0, (stage)*150.0)
                output = draw_triangle # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
        ...
        if i == 2:                   
            ...
            if stage == 3:
                output = draw_square # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 4:
                core.setRelativeXYPosition(0, (stage-3)*150.0)
                output = draw_circle # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
        ...
        if i == 3:                   
            if stage == 1:
                core.setRelativeXYPosition(0, (stage+2)*150.0)
                output = draw_plus # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 2:
                output = draw_square # output can equal draw_circle, draw_square, draw_triangle, draw_rectangle, draw_plus
            if stage == 3:
